...
def reportar_mascota_desaparecida(mongodb, mascota_desaparecida, azure_storage_cliente_mascotas):
    fecha_busqueda = datetime.now()
    print('Inicio de reportar desaparición: {}'.format(fecha_busqueda))
    try:
        # Crear archivo temporal
        ...
        if flag:
            add_image_to_memory_predictions(nombre_imagen_a_predecir, label)
